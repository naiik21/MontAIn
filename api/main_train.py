...
from datasetter import build_dataset_from_file
from map import get_map, get_elevation
...
def main():  
    ...
    # dataset = datasetter.build_dataset_from_file("data\gpx\Alta Via n 1 della Valle dAosta - Tappa 17_9678938.gpx")
    # print(dataset)
    
    # elevation_plot = get_elevation("data\porte-puymorens-pic-de-la-mina-iniciacio-a-lesqui-de-muntany.gpx")
