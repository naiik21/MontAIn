 ...
 */
export function GPXDetails({ gpxData, description }) {
  ...
  return (
    <>
      ...
      {description && (
        <div className="section">
          <div className="section-title">Descripción de la ruta</div>
          <div style={{ fontSize: '14px', color: '#444444', lineHeight: '1.6', whiteSpace: 'pre-wrap' }}>
            {description}
          </div>
        </div>
      )}
